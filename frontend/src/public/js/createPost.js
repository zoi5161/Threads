  ...
  return `
     <div class="post">
                <div class="post-header">
                    ...
                    <div class="three_dots_button" style="color: white; font-size: 100%; display: flex; justify-content: center; align-items: center; width: 10%; margin-left: 2rem">
    <button style="border-color: #3b3a3a; border-radius: 50%; background-color: #1e1e1e; height: 1.5rem; width: 1.5rem;"
    ...
    <ul class="dropdown-menu dropdown-menu-end" style="margin-bottom: 10px; border-radius: 15px; background-color: #1e1e1e; color: white; width: 250px;">
...
function createPostTopHTML(user) {
  return `    
